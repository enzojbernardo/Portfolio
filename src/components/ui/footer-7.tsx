...
export const Footer7 = ({
  logo = {
    ...
    src: 'https://images.unsplash.com/photo-1515879218367-8466d910aaa4?auto=format&fit=crop&w=120&q=80',
    alt: 'logo',
        ...
        <div className="flex w-full flex-col justify-between gap-10 lg:flex-row lg:items-start lg:text-left">
          <div className="flex w-full flex-col justify-between gap-6 lg:items-start">
            <div className="flex items-center gap-2 lg:justify-start">
              <a
                href={logo.url}
                target={isExternalLink(logo.url) ? '_blank' : undefined}
                rel={isExternalLink(logo.url) ? 'noreferrer noopener' : undefined}
              >
              ...
              {socialLinks.map((social, idx) => (
                <li key={idx} className="font-medium hover:text-primary">
                  <a
                    ...
                    rel={isExternalLink(social.href) ? 'noreferrer noopener' : undefined}
                  >
                    {social.icon}
                  </a>
                </li>
